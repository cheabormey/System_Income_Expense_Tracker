...
import ReimbursementsReport from "@/report/ReimbursementsReport.vue";
import CustomerReturnsReport from "@/report/CustomerReturnsReport.vue";
const routes = [
  {
    path: "/",
    ...
    children: [
      ...
      {
        path: "/debt-report",
        component: ReimbursementsReport,
      },
      {
        path: "/returns-report",
        component: CustomerReturnsReport,
      },
    ],
  },
  {
